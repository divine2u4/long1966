...
L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
  attribution:
    '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> Contributors:<a href="https://github.com/divine2u4/long1966">1966long</a>',
}).addTo(map);
...
let data;
/*
https://raw.githubusercontent.com/kiang/pharmacies/master/json/points.json  V1.0 */
/*https://www.tgos.tw/MapSites/getGeoJson?themeid=38356  v1.1*/
function getData() {
  const xhr = new XMLHttpRequest();
  xhr.open(
    "get",
    "https://raw.githubusercontent.com/yi960199/kkbox/main/%E5%8F%B0%E5%8C%97%E5%B8%82.json", //v2.0
    true
  ); //you data
  xhr.send(null);
  xhr.onload = function () {
